...
{
    public class CustomerMasterDetailPageMasterViewModel : INotifyPropertyChanged
    {
        private readonly ITinyMessengerHub _messenger;
        private IMenuItem _selectedItem;

        public CustomerMasterDetailPageMasterViewModel(IEnumerable<ICustomerMenuItem> menuItems,
